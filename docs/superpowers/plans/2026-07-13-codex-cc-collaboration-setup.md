...
- 主目录固定为 `C:\Users\yaokui\Documents\strength-periodization-manager`。
...
```powershell
Set-Location 'C:\Users\yaokui\Documents\strength-periodization-manager\.worktrees\claude-exercise-catalog-today'
