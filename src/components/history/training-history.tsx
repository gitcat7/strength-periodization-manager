...
import { Brain, CalendarDays, Dumbbell, Loader2, Moon, Save, TrendingUp } from "lucide-react";
          ...
          return (
            <article className="rounded-xl border border-line bg-white p-4" key={workout.id}>
              <div className="mb-4 flex items-start justify-between gap-3">
                <div>
                  <p className="text-sm text-muted">{workout.scheduled_date}</p>
                  <h2 className="flex items-center gap-2 font-semibold"><Dumbbell size={16} />{workout.name}</h2>
